...
<div class='header'>
	...
	<!-- 浮层 detail -->
	<div v-show='detailShow' class='detail' transition='fade'> <!-- sticky footers -->
		<div class='detail-wrapper clearfix'>
			<div class='detail-main'>
				...
				<ul v-if='seller.supports' class='supports'>
					<li v-for='(idx, item) in seller.supports' class='support-item'>
		...
		<div class='detail-close'>
			<i class='icon-close' @click='hideDetail' style='cursor:pointer;'></i>
		</div>
	</div>
</div>
</template>
...
.header
	...
	.bulletin-wrapper
		...
		// font-size: 0 //虽然能处理留白问题，但是省略号没有了
		.bulletin-title
			display: inline-block
			width: 22px;
			height: 12px;
